...
./resize_and_crop_images.py --num_clients=16 --image_lib=opencv --input=~/caffe/data/ilsvrc12/trainn.txt --input_folder=/storage/datasets/ILSVRC2012/train/ --output_folder=/storage/datasets/ILSVRC2012/train_resized/
